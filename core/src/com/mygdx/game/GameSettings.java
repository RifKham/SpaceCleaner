...
public class GameSettings {
    ...
    public static float SHIP_FORCE_RATIO = 3;
    public static float TRASH_VELOCITY = 20;
    public static long STARTING_TRASH_APPEARANCE_COOL_DOWN = 1700; // in [ms] - milliseconds
    public static int BULLET_VELOCITY = 1000; // in [m/s] - meter per second
